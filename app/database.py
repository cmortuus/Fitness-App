...
async def seed_exercises() -> None:
    ...
    async with async_session_factory() as session:
        default_exercises = [
            ...
            {"name": "barbell_row", "display_name": "Barbell Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps", "hamstrings"]},
            {"name": "pendlay_row", "display_name": "Pendlay Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "dumbbell_row", "display_name": "Dumbbell Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"], "is_unilateral": True},
            {"name": "cable_row", "display_name": "Cable Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "seated_cable_row", "display_name": "Seated Cable Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            ...
            {"name": "machine_row", "display_name": "Machine Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "t_bar_row", "display_name": "T-Bar Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "meadows_row", "display_name": "Meadows Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"], "is_unilateral": True},
            {"name": "inverted_row", "display_name": "Inverted Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "seal_row", "display_name": "Seal Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "smith_machine_row", "display_name": "Smith Machine Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "trap_bar_row", "display_name": "Trap Bar Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "one_arm_cable_row", "display_name": "One Arm Cable Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"], "is_unilateral": True},
            {"name": "hammer_strength_row", "display_name": "Hammer Strength Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "iso_lateral_row", "display_name": "ISO Lateral Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "ring_row", "display_name": "Ring Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "yates_row", "display_name": "Yates Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            # Lower Back
            {"name": "back_extension", "display_name": "Back Extension", "movement_type": "isolation", "body_region": "lower", "primary_muscles": ["lower back"], "secondary_muscles": ["hamstrings", "glutes"]},
            {"name": "reverse_hyperextension", "display_name": "Reverse Hyperextension", "movement_type": "isolation", "body_region": "lower", "primary_muscles": ["lower back"], "secondary_muscles": ["hamstrings", "glutes"]},
            ...
            {"name": "face_pull", "display_name": "Face Pull", "movement_type": "isolation", "body_region": "upper", "primary_muscles": ["shoulders", "upper back"], "secondary_muscles": []},
            {"name": "cable_face_pull", "display_name": "Cable Face Pull", "movement_type": "isolation", "body_region": "upper", "primary_muscles": ["shoulders", "upper back"], "secondary_muscles": []},
            ...
            {"name": "band_pull_apart", "display_name": "Band Pull Apart", "movement_type": "isolation", "body_region": "upper", "primary_muscles": ["shoulders", "upper back"], "secondary_muscles": []},
            {"name": "prone_y_raise", "display_name": "Prone Y Raise", "movement_type": "isolation", "body_region": "upper", "primary_muscles": ["shoulders", "upper back"], "secondary_muscles": []},
            ...
            {"name": "w_raise", "display_name": "W Raise", "movement_type": "isolation", "body_region": "upper", "primary_muscles": ["shoulders", "upper back"], "secondary_muscles": []},
            ...
            {"name": "rack_pull", "display_name": "Rack Pull", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["traps", "upper back"], "secondary_muscles": ["hamstrings", "glutes"]},
            ...
            {"name": "front_squat", "display_name": "Front Squat", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["quadriceps"], "secondary_muscles": ["glutes", "hamstrings", "lower back"]},
            ...
            {"name": "zercher_squat", "display_name": "Zercher Squat", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["quadriceps"], "secondary_muscles": ["glutes", "hamstrings", "lower back"]},
            ...
            # ========== HAMSTRINGS ==========
            {"name": "deadlift", "display_name": "Deadlift", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["hamstrings", "glutes"], "secondary_muscles": ["lower back", "traps", "quadriceps"]},
            {"name": "sumo_deadlift", "display_name": "Sumo Deadlift", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["hamstrings", "glutes", "quadriceps"], "secondary_muscles": ["lower back", "traps"]},
            {"name": "romanian_deadlift", "display_name": "Romanian Deadlift", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["hamstrings"], "secondary_muscles": ["glutes", "lower back"]},
            {"name": "stiff_leg_deadlift", "display_name": "Stiff Leg Deadlift", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["hamstrings"], "secondary_muscles": ["glutes", "lower back"]},
            ...
            {"name": "good_morning", "display_name": "Good Morning", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["hamstrings"], "secondary_muscles": ["lower back", "glutes"]},
            {"name": "single_leg_rdl", "display_name": "Single Leg RDL", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["hamstrings"], "secondary_muscles": ["glutes", "lower back"], "is_unilateral": True},
            {"name": "trap_bar_deadlift", "display_name": "Trap Bar Deadlift", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["hamstrings", "quadriceps", "glutes"], "secondary_muscles": ["lower back", "traps"]},
            {"name": "pause_deadlift", "display_name": "Pause Deadlift", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["hamstrings", "glutes"], "secondary_muscles": ["lower back", "traps", "quadriceps"]},
            {"name": "deficit_deadlift", "display_name": "Deficit Deadlift", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["hamstrings", "glutes"], "secondary_muscles": ["lower back", "traps", "quadriceps"]},
            ...
            {"name": "kettlebell_swing", "display_name": "Kettlebell Swing", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["glutes", "hamstrings"], "secondary_muscles": ["lower back", "shoulders"]},
            ...
            {"name": "bird_dog", "display_name": "Bird Dog", "movement_type": "isolation", "body_region": "full_body", "primary_muscles": ["core", "lower back"], "secondary_muscles": []},
            ...
            # ========== POWER / ATHLETIC ==========
            {"name": "power_clean", "display_name": "Power Clean", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["quadriceps", "glutes"], "secondary_muscles": ["lower back", "traps", "shoulders"]},
            {"name": "hang_clean", "display_name": "Hang Clean", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["quadriceps", "glutes"], "secondary_muscles": ["lower back", "traps", "shoulders"]},
            {"name": "clean_and_jerk", "display_name": "Clean and Jerk", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["quadriceps", "glutes", "shoulders"], "secondary_muscles": ["lower back", "traps"]},
            {"name": "snatch", "display_name": "Snatch", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["quadriceps", "glutes", "shoulders"], "secondary_muscles": ["lower back", "traps"]},
            {"name": "hang_snatch", "display_name": "Hang Snatch", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["quadriceps", "glutes", "shoulders"], "secondary_muscles": ["lower back", "traps"]},
            ...
            {"name": "sled_pull", "display_name": "Sled Pull", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["hamstrings", "glutes"], "secondary_muscles": ["upper back", "biceps"]},
            {"name": "battle_ropes", "display_name": "Battle Ropes", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["shoulders", "core"], "secondary_muscles": ["upper back", "biceps"]},
            {"name": "medicine_ball_slam", "display_name": "Medicine Ball Slam", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["core", "shoulders"], "secondary_muscles": ["lats", "quadriceps"]},
            ...
            {"name": "cambered_bar_row", "display_name": "Cambered Bar Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            ...
            {"name": "cambered_bar_deadlift", "display_name": "Cambered Bar Deadlift", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["hamstrings", "glutes"], "secondary_muscles": ["lower back", "traps"]},
            ...
            {"name": "cambered_bar_good_morning", "display_name": "Cambered Bar Good Morning", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["hamstrings"], "secondary_muscles": ["lower back", "glutes"]},
            ...
            {"name": "ssb_good_morning", "display_name": "SSB Good Morning", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["hamstrings"], "secondary_muscles": ["lower back", "glutes"]},
            ...
            {"name": "ez_bar_row", "display_name": "EZ Bar Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            ...
            {"name": "ez_bar_good_morning", "display_name": "EZ Bar Good Morning", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["hamstrings"], "secondary_muscles": ["lower back", "glutes"]},
            ...
            {"name": "swiss_bar_row", "display_name": "Swiss Bar Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            ...
            # --- Axle Bar ---
            {"name": "axle_bar_deadlift", "display_name": "Axle Bar Deadlift", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["hamstrings", "glutes"], "secondary_muscles": ["lower back", "traps", "forearms"]},
            ...
            {"name": "axle_bar_row", "display_name": "Axle Bar Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps", "forearms"]},
            ...
            {"name": "log_clean_and_press", "display_name": "Log Clean and Press", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["shoulders", "quadriceps"], "secondary_muscles": ["triceps", "lower back"]},
            ...
            {"name": "duffalo_bar_deadlift", "display_name": "Duffalo Bar Deadlift", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["hamstrings", "glutes"], "secondary_muscles": ["lower back", "traps"]},
            ...
            {"name": "wide_grip_bench_press", "display_name": "Wide Grip Bench Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "neutral_grip_bench_press", "display_name": "Neutral Grip Bench Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "close_grip_incline_press", "display_name": "Close Grip Incline Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest", "triceps"], "secondary_muscles": ["shoulders"]},
            {"name": "wide_grip_incline_press", "display_name": "Wide Grip Incline Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "neutral_grip_incline_press", "display_name": "Neutral Grip Incline Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "close_grip_decline_press", "display_name": "Close Grip Decline Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest", "triceps"], "secondary_muscles": ["shoulders"]},
            {"name": "wide_grip_decline_press", "display_name": "Wide Grip Decline Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "neutral_grip_decline_press", "display_name": "Neutral Grip Decline Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "close_grip_machine_chest_press", "display_name": "Close Grip Machine Chest Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest", "triceps"], "secondary_muscles": ["shoulders"]},
            {"name": "wide_grip_machine_chest_press", "display_name": "Wide Grip Machine Chest Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "neutral_grip_machine_chest_press", "display_name": "Neutral Grip Machine Chest Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "close_grip_barbell_row", "display_name": "Close Grip Barbell Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "wide_grip_barbell_row", "display_name": "Wide Grip Barbell Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "neutral_grip_barbell_row", "display_name": "Neutral Grip Barbell Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "close_grip_cable_row", "display_name": "Close Grip Cable Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "wide_grip_cable_row", "display_name": "Wide Grip Cable Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "neutral_grip_cable_row", "display_name": "Neutral Grip Cable Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},

            # ========== INCLINE ANGLE VARIATIONS ==========
            {"name": "15_degree_incline_dumbbell_press", "display_name": "15\u00b0 Incline Dumbbell Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "30_degree_incline_dumbbell_press", "display_name": "30\u00b0 Incline Dumbbell Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "45_degree_incline_dumbbell_press", "display_name": "45\u00b0 Incline Dumbbell Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest", "shoulders"], "secondary_muscles": ["triceps"]},
            {"name": "15_degree_smith_machine_press", "display_name": "15\u00b0 Smith Machine Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "30_degree_smith_machine_press", "display_name": "30\u00b0 Smith Machine Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "45_degree_smith_machine_press", "display_name": "45\u00b0 Smith Machine Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest", "shoulders"], "secondary_muscles": ["triceps"]},
            ...
            {"name": "15_degree_machine_press", "display_name": "15\u00b0 Machine Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            {"name": "30_degree_machine_press", "display_name": "30\u00b0 Machine Press", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["chest"], "secondary_muscles": ["triceps", "shoulders"]},
            ...
            {"name": "kroc_row", "display_name": "Kroc Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps", "forearms"], "is_unilateral": True},
            ...
            {"name": "jefferson_squat", "display_name": "Jefferson Squat", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["quadriceps", "glutes"], "secondary_muscles": ["hamstrings", "lower back"]},
            ...
            {"name": "cable_woodchop", "display_name": "Cable Woodchop", "movement_type": "compound", "body_region": "full_body", "primary_muscles": ["obliques", "core"], "secondary_muscles": ["shoulders"]},
            ...
            {"name": "chest_supported_row_machine", "display_name": "Chest Supported Row Machine", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
            {"name": "low_row_machine", "display_name": "Low Row Machine", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["upper back"], "secondary_muscles": ["biceps"]},
