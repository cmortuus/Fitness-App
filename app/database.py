...
async def seed_exercises() -> None:
    ...
    async with async_session_factory() as session:
        default_exercises = [
            ...
            {"name": "single_arm_lat_pulldown", "display_name": "Single Arm Lat Pulldown", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["back"], "secondary_muscles": ["biceps"], "is_unilateral": True},
            ...
            {"name": "single_leg_rdl", "display_name": "Single Leg RDL", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["hamstrings"], "secondary_muscles": ["glutes", "back"], "is_unilateral": True},
            ...
            {"name": "close_grip_barbell_row", "display_name": "Close Grip Barbell Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["back"], "secondary_muscles": ["biceps"]},
            {"name": "wide_grip_barbell_row", "display_name": "Wide Grip Barbell Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["back"], "secondary_muscles": ["biceps"]},
            {"name": "neutral_grip_barbell_row", "display_name": "Neutral Grip Barbell Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["back"], "secondary_muscles": ["biceps"]},
            {"name": "close_grip_cable_row", "display_name": "Close Grip Cable Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["back"], "secondary_muscles": ["biceps"]},
            {"name": "wide_grip_cable_row", "display_name": "Wide Grip Cable Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["back"], "secondary_muscles": ["biceps"]},
            {"name": "neutral_grip_cable_row", "display_name": "Neutral Grip Cable Row", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["back"], "secondary_muscles": ["biceps"]},
            ...
            {"name": "reverse_grip_lat_pulldown", "display_name": "Reverse Grip Lat Pulldown", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["back"], "secondary_muscles": ["biceps"]},
            {"name": "jefferson_squat", "display_name": "Jefferson Squat", "movement_type": "compound", "body_region": "lower", "primary_muscles": ["quadriceps", "glutes"], "secondary_muscles": ["hamstrings", "back"]},
            ...
            {"name": "chest_supported_row_machine", "display_name": "Chest Supported Row Machine", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["back"], "secondary_muscles": ["biceps"]},
            {"name": "low_row_machine", "display_name": "Low Row Machine", "movement_type": "compound", "body_region": "upper", "primary_muscles": ["back"], "secondary_muscles": ["biceps"]},
